...
- Fetch data with `api.*` in useEffect or inline async
- Pages receive real-time updates by consuming `useWebSocket()` directly

## Styling (clnode-specific)
- Dark theme: `bg-gray-900`, `text-gray-100` palette
- Status colors: green (active/completed), yellow (in_progress), gray (pending)
- Consistent card pattern: `bg-gray-800 rounded-lg p-4`
